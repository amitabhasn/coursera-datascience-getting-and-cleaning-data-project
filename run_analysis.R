...
############################################
# Create the directory if not exist the download files
if(!file.exists("./data")){dir.create("./data")}
fileUrl <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
download.file(fileUrl,destfile="./data/Dataset.zip", method = 'auto') #for Windows
...
write.table(secTidySet, "./data/secTidySet.txt", row.name=FALSE)